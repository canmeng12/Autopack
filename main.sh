...
#adguardhome,bypass
git clone --depth 1 https://github.com/kiddin9/openwrt-packages packages12 && mv -n packages12/{luci-app-adguardhome,luci-app-bypass} ./ && mv -n packages12/adguardhome ./packages/
rm -rf packages12
...
cd packages
git_sparse_clone master "https://github.com/immortalwrt/packages" "imm" devel/gn net/{brook,cdnspeedtest,chinadns-ng,dns2socks,dns2tcp,hysteria,microsocks,naiveproxy,pdnsd-alt,redsocks2,sagernet-core,shadowsocksr-libev,shadowsocks-rust,simple-obfs,tcping,trojan,trojan-plus,v2ray-geodata,v2ray-plugin,xray-core,xray-plugin,mosdns} utils/cpulimit
